...
// FileReader* BM_PrimaryGenerator::fileReader = 0;
...
void BM_PrimaryGenerator::GeneratePrimaries(G4Event* anEvent)
{
  ...
  // He Generation
     ...
     double randnew4 = 0.;
    std::vector<double> ncEn = FileReader().cEn;
  //  //G4cout << ncEn.at(0) << G4endl;
    std::vector<double> ncIn = FileReader().cIn;
  //  //G4cout << ncIn.at(0) << G4endl;
